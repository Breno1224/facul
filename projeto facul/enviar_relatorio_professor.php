...
<head>
    ...
    <style>
        ...
        .form-section select { width: 100%; padding: 0.75rem; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; }
        ...
        .list-section th, .list-section td { padding: 0.75rem; border: 1px solid #ddd; text-align: left; font-size: 0.9rem; vertical-align: top; }
        .list-section th { background-color: #f2f2f2; }
        .list-section .actions a { margin-right: 10px; text-decoration: none; }
        .list-section .comment-cell { font-style: italic; font-size: 0.85em; color: #555; }
        .list-section .comment-cell small { color: #777; }
    </style>
</head>
<body>
    <header>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <?php if(isset($_SESSION['relatorio_status_message'])): ?>
                <div class="status-message <?php echo $_SESSION['relatorio_status_type']; ?>"><?php echo $_SESSION['relatorio_status_message']; ?></div>
            ...
            <section class="list-section">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Enviado em</th>
                            <th>Comentário da Coordenação</th> </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="comment-cell"> <?php if(!empty($relatorio['comentario_coordenacao'])): ?>
                                    <em><?php echo htmlspecialchars(mb_substr($relatorio['comentario_coordenacao'], 0, 40)); // Mostra um trecho ?>
                ...
                <?php endif; ?>
                <?php if(isset($stmt_relatorios)) mysqli_stmt_close($stmt_relatorios); ?>
            </section>
        </main>
    </div>
